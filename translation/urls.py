...
from .views import EndpointView, MLAlgoirthmView, MLRequestView, TranslateView, SearchAndUpdateAPIView, TranslateStringView, Home, ExcelFileTranslate, send_files
